...
COLOR_MIN = np.array([5, 90, 50], np.uint8) #min and max hsv thresholds
...
def main():
	...
	capture.set(15, -5)
	last_approx = np.array([[319, 240], [319, 240], [319, 240], [319, 240], [319, 240], [319, 240], [319, 240], [319, 240]]).reshape((-1, 1, 2)).astype(np.int32) #this took way too long to figure out lol
	while 1:
		...
		if len(contours) != 0: #put contours in an array
			...
			approx = cv2.approxPolyDP(largestContour, epsilon, True) #approximate polygon from contour
